# -*- encoding: utf-8 -*-
# stub: has_friendship 1.0.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rails>, ["< 5.1.0", ">= 4.0.0"])
      s.add_runtime_dependency(%q<stateful_enum>, [">= 0"])
      ...
      s.add_dependency(%q<rails>, ["< 5.1.0", ">= 4.0.0"])
      s.add_dependency(%q<stateful_enum>, [">= 0"])
